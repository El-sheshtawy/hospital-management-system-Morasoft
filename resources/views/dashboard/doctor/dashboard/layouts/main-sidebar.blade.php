    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('doctor.invoices.index') }}">قائمة جميع الكشوفات</a></li>
                    <li><a class="slide-item" href="{{ route('doctor.invoices.completed.index') }}">قائمة الكشوفات المكتملة</a></li>
                    <li><a class="slide-item" href="{{ route('doctor.invoices.revisions.index') }}">قائمة المراجعات</a></li>
