...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.doctors.update', $doctor->id) }}" method="post" autocomplete="off"
                            ...
                            <div>
                                @if($doctor->image)
                                    <img style="border-radius:20%"
                                         src="{{Url::asset('/images/dashboard/doctors/'.$doctor->image->filename)}}"
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select multiple="multiple" class="testselect2" name="appointments[]">
                                        @foreach($appointments as $appointment)
                                            ...
                                            @selected(in_array($appointment->id, old('appointments', $doctorAppointments)))>
                                                {{$appointment->name}}
                                            </option>
                                        @endforeach
                                    </select>
