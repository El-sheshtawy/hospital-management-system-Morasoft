...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">جميع الخدمات</h4>
...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.insurances.store')}}" method="post" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                @error('percentage_costs_insurance')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
