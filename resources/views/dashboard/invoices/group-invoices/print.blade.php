    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ طباعه الفواتير</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row">
                                    <span>اسم الخدمه</span>
                                    <span>{{ request('group_services_name') }}</span>
                                </p>
                                <p class="invoice-info-row">
                                    <span>اسم المريض</span>
                                    <span>{{ Request::get('patient_name') }}</span>
                                </p>
                                <p class="invoice-info-row">
                                    <span>تاريخ الفاتوره</span><span>{{ Request::get('date') }}</span>
                                </p>
                                <p class="invoice-info-row">
                                    <span>الدكتور</span> <span></span>{{ Request::get('doctor_id') }}
                                </p>
                                <p class="invoice-info-row">
                                    <span>القسم</span> <span></span>{{ Request::get('section_id') }}
                                </p>
                            </div>
                        </div>
