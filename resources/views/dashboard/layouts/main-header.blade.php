				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							...
							<a href="{{ url('/' . $page='index') }}">
								<img src="{{URL::asset('dashboard/img/brand/logo-white.png')}}" class="dark-logo-1"
									 alt="logo">
							</a>
							<a href="{{ url('/' . $page='index') }}">
							...
							<a href="{{ url('/' . $page='index') }}">
								<img src="{{URL::asset('dashboard/img/brand/favicon.png')}}" class="dark-logo-2"
									 alt="logo">
							</a>
						</div>
									   ...
									   aria-expanded="false">
										@if(App::getLocale() == 'ar')
											<span class="avatar country-Flag mr-0 align-self-center bg-transparent">
												<img src="{{URL::asset('dashboard/img/flags/egypt_flag.png')}}" alt="img">
											</span>
										...
										@elseif(App::getLocale() == 'fr')
											<span class="avatar country-Flag mr-0 align-self-center bg-transparent">
												<img src="{{URL::asset('dashboard/img/flags/french_flag.JPG')}}" alt="img">
											</span>
											<strong class="mr-2 ml-2 my-auto">
												{{ LaravelLocalization::getCurrentLocaleName() }}
											</strong>
							...
							{{-- Notifications Part --}}
								...
								<div class="dropdown-menu dropdown-notifications">
									<div class="menu-header-content bg-primary text-right">
                                        ...
                                        <p data-count="0" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 notif-count ">
										0
										</p>
									</div>
									...
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user">
												<img alt="" src="{{URL::asset('dashboard/img/faces/6.jpg')}}" class="">
											</div>
											<div class="mr-3 my-auto">
												<h6>{{ auth()->user()->name ?? '' }}</h6><span>Adminstrator member</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>Profile</a>
									<a class="dropdown-item" href="{{ route('admin.roles.index') }}"><i class="bx bx-slider-alt"></i>Roles</a>
									<a class="dropdown-item" href="{{ route('admin.permissions.index') }}"><i class="bx bx-slider-alt"></i>Permissions</a>
									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>Messages</a>
									<a class="dropdown-item" href=""><i class="bx bx-slider-alt">
							...
							<div class="dropdown main-header-message right-toggle">
								<a class="nav-link pr-0" data-toggle="sidebar-left" data-target=".sidebar-left">
									<svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs"
										 viewBox="0 0 24 24"
										 fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
										 stroke-linejoin="round" class="feather feather-menu"><line x1="3" y1="12"
																									x2="21"
											y2="12"></line><line x1="3" y1="6" x2="21" y2="6">
										</line>
...
<script>
    ...
    var notificationCount      = parseInt(notificationsCountElem.data('count'));
    var notifications          = notificationsWrapper.find('Notification-scroll.h5');

    Pusher.logToConsole = true;

    var pusher = new Pusher('99fdbfb2b97c0a5453a4', {
        cluster: 'mt1'
    });
