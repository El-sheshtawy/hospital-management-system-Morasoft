    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ سندات القبض</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="{{route('admin.receipts.create')}}" class="btn btn-primary" role="button"
                            ...
                            @foreach($receipts as $receipt)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.receipts.print',$receipt->id)}}"
                                           class="btn btn-primary btn-sm"
                                           target="_blank" title="طباعه سند قبض">
...
@endsection
@push('extra_js')
    @include('dashboard.receipts.extra-js')
@endpush